...
formEl.addEventListener("input", (0, _lodashThrottleDefault.default)(onFormValue, 500));
formEl.addEventListener("submit", onFormSubmit);
formSavedData();
function onFormValue(e) {
    localStorage.setItem(FEEDBACK_STATE, JSON.stringify({
        email: inputEl.value,
...
function onFormSubmit(e) {
    e.preventDefault();
    console.log(JSON.parse(`{"email":"${inputEl.value}","message":"${textareaEl.value}"}`));
    e.target.reset();
}
